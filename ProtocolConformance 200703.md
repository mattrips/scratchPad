...
However, constraint *c3* on conformance `X<Int>: P` is  (i.e., the conformance is unconstrained).  Constraint *c2* is not a superset of constraint *c3*.  Consequently, per the rule stated at the outset of this Section 1.5.4,  *i2* is disregarded for purposes of the conformance `X<Int>: P`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIyODI1NTU0OSwxMjg5Mjc1Mzg2LDU5Mj
