...
Given concretization `T`, the conformance `T: P`, and requirement *m* of `P`, if an implementation *i* of *m* is constrained differently than `T: P` is constrained,      
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkxNTE0NzkxMSwtMjA4NzMzNjI5MywtMT
