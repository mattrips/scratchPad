...
of `T` 
that satisfies *m* is referred to as an *implementation* of *m*.

A type may have a multitude of implementations of a requirement.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNjM2OTc0OSwtMjA5MTY1NjU5MywtNT
