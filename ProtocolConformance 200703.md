...
However, *i2* is disregarded for purposes of the conformance `X<Int>: P`.  The constraint on the conformance is always satisfied (i.e., there is no constraint on the conformance.     

Constraint *c2* is not a superset of the constraint *c3* on  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTc1MTE3OTk1LDU5MjA5MDUwNiwtMjA4Nz
