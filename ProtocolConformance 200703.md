...
Given concretization `T`, the conformance `T: P`, requirement *m* of `P`, if the constraints on `T: P` are not a superset of the constraints on implementation *i* of *m*, then *i* is unavailable for purposes of conformance `T: P`.  This unavailability persists regardless of whether the constraints on *i* are satisfied by `T`.       
>***Discussion**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI1NDI5OTY2Myw1OTIwOTA1MDYsLTIwOD
