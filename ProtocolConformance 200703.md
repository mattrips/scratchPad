...
A conformance is not declared.  It is created in response to a named concrete type being declared to conform to a protocol, and its content is inferred from the context.[^2]  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY2NTQzMDUwMCwxMzI1NTg2NjUyLDE2OT
