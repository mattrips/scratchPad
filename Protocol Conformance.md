...
: Given a protocol, a statement in the declaration of a protocol that describes a member that a type must have as a condition  be eligible to conform to the protocol.
...
AnJ1xuIiwiaGlzdG9yeSI6WzM4MjE4NDkxMSwxMjM1OTUxNDEs
