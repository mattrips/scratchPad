...
&#9724;   In complex arrangements, it may be perceived that the witness varies.  Sometimes, this appearance is due to a different protocol being used, with both protocols .  Other times, this appearance is due to complexity making it difficult to reason about which implementation is the witness for a protocol requirement.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM5NDQ3NjE3MywtMTM1NzE3NjQzLDc5MD
