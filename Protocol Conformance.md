...
&#9724; witness
: Given a declaration that a type conforms to a protocol and given a protocol requirement of the protocol, the ***witness*** is the particular implementation used by the type to satisfy the protocol requirement.
...
AnJ1xuIiwiaGlzdG9yeSI6Wzg4ODQxNjc5MCwxMjM1OTUxNDEs
