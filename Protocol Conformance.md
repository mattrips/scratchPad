...
&#9724;   In complex arrangements, it sometimes is perceived that the witness varies.  Sometimes, this appearance is due to a different protocol being used.  Other times, this appearance is due to complexity making it difficult to reason about which implementation is the witness for a protocol requirement.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTgwMDIxNzIzLC0xMzU3MTc2NDMsNzkwNj
