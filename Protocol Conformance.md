...
: Given a protocol, a statement in the declaration of a protocol that describes a property, method, initializer, subscript or associatedtype that a type conforming to the protocol must implement.
